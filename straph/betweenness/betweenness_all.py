...
def betweenness_all_dis_gen(s, b, fun, walk_type, approx = -1):
    ...
    for node in to_visit:
        ...
        e_time = time.time()
        print("finish optimal paths", (s_time - e_time)/60)
        s_time = time.time()
        G = bt.predecessor_graph_dis_gen(s, pre,node)
        preced = bt.preced_node(s, G,events,events_reverse)
        e_time = time.time()
        print("finish predecessor", (s_time - e_time)/60, "size pred", len(G.nodes()))
        s_time = time.time()
        ...
        GG = bt.graph_to_ordered(G, events, events_reverse)
        e_time = time.time()
        print("remove and ordrered", (s_time - e_time)/60, "new size", len(G.nodes()))
        ...
        e_time = time.time()
        print("finish sigma_r, sigma_tot", (s_time - e_time)/60)
        ...
        e_time = time.time()
        print("finish contribution", (s_time - e_time)/60)
